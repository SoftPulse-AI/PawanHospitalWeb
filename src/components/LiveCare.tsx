...
const moments = [
  ...
  },
  {
    ...
    icon: Baby,
    tag: "Care",
    title: "Safe Hands for Normal Delivery",
    desc: "Experienced gynecology team, modern facilities, and supportive nursing for a confident delivery experience.",
    stat: "More than 10,000",
    statLabel: "Normal Deliveries",
  },
  {
    img: nurseImg,
    icon: Heart,
